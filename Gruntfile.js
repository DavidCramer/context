    ...
    grunt.initConfig({
                ...
                files:[
                    {
                        ...
                        dest: '../<%= pkg.plugin_name.toLocaleLowerCase().replace(/ /g, '-' ) %>-bootstrap.php'
                    },
                    {
                        expand: false,
                        cwd: './',
                        src: 'context.php',
                        dest: '../<%= pkg.plugin_name.toLocaleLowerCase().replace(/ /g, '-' ) %>.php'
                    },
                    {
                        expand: true,
                        cwd: 'includes',
        ...
        rename: {
            core: {
                ...
                dest: '../classes/class-<%= pkg.plugin_name.toLocaleLowerCase().replace(/ /g, '-' ) %>.php'
            }
        },
        uglify: {
            min: {
